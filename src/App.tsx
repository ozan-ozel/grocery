...
export function App() {
  ...
  const { tenants, activeTenantId, selectTenant, addTenant, renameTenant, deleteTenant } =
    useTenants();

  const { state, setState, updateState, stateRef, syncStatus } = useListSync(activeTenantId);
