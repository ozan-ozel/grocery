...
// `comboId` is set only when this item was logged via "Yedim" on an evening
// suggestion — MealPlanView groups by it to reconstruct the eaten combo after a reload.
