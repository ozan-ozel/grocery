## GOAL
	...
	Determine the user’s primary goal category (maintenance, weight loss, weight gain, muscle/lean-mass ... ?
	
	Determine whether a vague or purely qualitative goal statement (“get healthier,” “feel better”) can be… ?

## BASELINE PROFILE

	MVP, done in individualization
...
## Body composition
	...
	Create a single mvp scope feature for this.

## Macros - MVP, done in individualization
	...
	Determine how a disclosed dietary pattern or restriction (for mvp only => vegan, vegetarian, pescatarians) constrains… - TO BE IMPLEMENTED
...
## Meal Structure
	...
	Determine how pre-exercise, during-exercise, and post-exercise/recovery nutrient timing needs are - V2, Backlog

	Determine how daily macro/energy targets are distributed across the chosen eating occasions - MISSING
...
## Monitoring
	...
	Determine what data the application asks the user to log routinely, and at what cadence, across weight - MISSING
...
## Governance/Confidence
	...
	Limit the scope of this, keep it simple.
